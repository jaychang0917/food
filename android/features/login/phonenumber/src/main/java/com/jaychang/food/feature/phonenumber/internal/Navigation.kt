...
internal sealed class Navigation : Event<Unit>() {
    data class Password(val phoneNumber: String) : Navigation()
    data class CountrySelection(val country: Country) : Navigation()
