...
internal class CountrySelectionFragment : BaseFragment() {
    ...
    internal val viewModel: CountrySelectionViewModel by viewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (view as CountrySelectionView).setViewModel(viewLifecycleOwner, viewModel)

        viewModel.onCountryItemClicked.observe(viewLifecycleOwner) {
            viewModel.selectedCountry(it.value.country)
            router.close()
        }
